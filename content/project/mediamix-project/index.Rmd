...
# Media Mix Model Example

I put this simple demonstration of a media mix modeling strategy together in R to document my process teaching myself this technique. It is adapted from a tutorial at <https://towardsdatascience.com/building-a-marketing-mix-model-in-r-3a7004d21239/>, extended with additional packages, models and visualization tools.

## Load data

I will use a sample dataset "marketing" from the R package `datarium`. This dataset contains 200 weeks of sales data and marketing spends (in £1000 units) for youtube, facebook and and newspaper channels.
...
Fortunately none is detected. Checking for bias and heteroscedacity:
...
This shows us that all of the week dummy variables, as well as newspaper spend and trend, have zero coefficients, meaning they do not add predictive power to the model and can be dropped. "Lasso penalizes complexity—even weakly significant variables"
...
Now refit an lm with only the selected variables:
...
# --- Step 2: Simulate 100 weeks of time-varying future spend ---
...
# --- Step 4: Predict sales using Lasso model ---
...
# --- Step 5: Combine with historical data for plotting ---
